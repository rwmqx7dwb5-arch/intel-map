...
,
  ...
  "following the clock": "suit l'horloge",
  ...
  "nearby": "à proximité",
  "nearest available data": "données disponibles les plus proches",
  ...
  "Night-lights tiles could not be loaded": "Impossible de charger les tuiles de lumières nocturnes",
  "No": "Non",
  ...
  "no satellite night-lights record exists before {y}": "il n'existe aucun relevé satellite des lumières nocturnes avant {y}",
  ...
  "Vision model": "Modèle visuel",
  "Image processing": "Traitement d’image",
  "This sends your photograph.": "Cette méthode envoie votre photographie.",
  "A reduced copy of the picture goes to the AI provider IntMap calls, to be traced. It is not stored. The image-processing detector sends nothing at all.": "Une copie réduite de l’image est envoyée au fournisseur d’IA appelé par IntMap, afin d’y tracer la crête. Elle n’y est pas conservée. Le détecteur par traitement d’image, lui, n’envoie rien du tout.",
  "Allow and detect": "Autoriser et détecter",
  "Sending the photograph is allowed on this browser.": "L’envoi de la photographie est autorisé sur ce navigateur.",
  "Withdraw": "Révoquer",
  "Asking the model where the sky stops…": "Le modèle cherche où s’arrête le ciel…",
  "Traced by": "Tracé par",
  "model confidence": "confiance du modèle",
  "over evaluated columns": "sur les colonnes évaluées",
  "The photograph has not been sent — allow it above first.": "La photographie n’a pas été envoyée — autorisez-le d’abord ci-dessus.",
  "No connection. The image-processing detector still works offline.": "Pas de connexion. Le détecteur par traitement d’image fonctionne toujours hors ligne.",
  "An account is needed to ask the model. The image-processing detector needs none.": "Un compte est nécessaire pour interroger le modèle ; le détecteur par traitement d’image n’en demande aucun.",
  "The model found no sky-and-land boundary in this photograph.": "Le modèle n’a trouvé aucune limite entre le ciel et la terre dans cette photographie.",
  "The reply traced too few points to be a ridge.": "La réponse a tracé trop peu de points pour former une crête.",
  "The traced ridge covers too little of the frame to search with.": "La crête tracée couvre une part trop faible de l’image pour lancer une recherche.",
  "The reply could not be read.": "La réponse n’a pas pu être lue.",
  "A reduced copy of your photograph was sent to the AI provider IntMap calls, to trace the ridge. It was not stored. Everything after that — the camera model, the sweep and the match — ran in this browser, and the elevation tiles were fetched by coordinate.": "Une copie réduite de votre photographie a été envoyée au fournisseur d’IA appelé par IntMap, pour y tracer la crête. Elle n’y a pas été conservée. Tout le reste — le modèle de caméra, le balayage et la comparaison — s’est exécuté dans ce navigateur, et les tuiles d’altitude ont été téléchargées par coordonnée.",
  ...
  "{n} row(s) had no usable value and are not drawn": "{n} ligne(s) sans valeur exploitable ne sont pas tracées",   /* atlas-chart.js (#R543) */
  "a {kind} needs at least {min} real points; {n} arrived": "un {kind} a besoin d’au moins {min} points réels ; {n} reçu(s)",   /* atlas-chart.js (#R543) */
  "a bar chart needs at least {min} labelled values; {n} arrived": "un diagramme en barres a besoin d’au moins {min} valeurs nommées ; {n} reçue(s)",   /* atlas-chart.js (#R543) */
  "a timeline needs at least {min} dated events; {n} arrived": "une chronologie a besoin d’au moins {min} événements datés ; {n} reçu(s)",   /* atlas-chart.js (#R543) */
  "chart kind must be one of {kinds}": "le type de graphique doit être l’un des suivants : {kinds}",   /* atlas-chart.js (#R543) */
  "every chart must say where its numbers came from (source)": "tout graphique doit indiquer d’où viennent ses chiffres (source)",   /* atlas-chart.js (#R543) */
  "{kind} chart, {x0} to {x1}, values {y0} to {y1}": "graphique {kind}, de {x0} à {x1}, valeurs de {y0} à {y1}",   /* atlas-chart.js (#R543) */
  "bar chart, {n} values from {y0} to {y1}": "diagramme en barres, {n} valeurs de {y0} à {y1}",   /* atlas-chart.js (#R543) */
  "timeline, {n} events from {y0} to {y1}": "chronologie, {n} événements de {y0} à {y1}",   /* atlas-chart.js (#R543) */
  "The chart renderer could not be loaded.": "Le moteur de rendu des graphiques n’a pas pu être chargé.",   /* atlas-console.js (#R543) */
  "Map as it was": "Carte d’alors",   /* atlas-msg-tools.js (#R543) */
  "Put the map back the way it was when this answer was written": "Remettre la carte dans l’état où elle était quand cette réponse a été écrite",   /* atlas-msg-tools.js (#R543) */
