...
window.IntMapPageI18N.define('de', {
  ...
  sourceUse: {
    ...
    'Yahoo Finance': 'Kurse der Aktienindizes für die Laufleiste und Live-Aktienkurse zur Berechnung der Marktkapitalisierung im Reiter „Unternehmen“ (in den USA notierte Titel). Der Reiter fragt zuerst die IntMap-eigene Edge Function quotes-relay und weicht nur dann auf die gemeinsam genutzten öffentlichen CORS-Relays aus, wenn diese nicht erreichbar ist; die Quelle sind in beiden Fällen Yahoos schlüsselfreie spark-/chart-Endpunkte, und gesendet wird ausschließlich das Tickersymbol — keine Koordinaten, kein Konto, nichts über Sie.',
    'Company logos — Wikidata (P154) via Wikimedia Commons, Google favicons as fallback': 'Das Logo neben jedem Unternehmen im Reiter „Unternehmen“. WELCHES Bild das Logo eines Unternehmens ist, beantwortet Wikidata mit der Eigenschaft P154; sie wird zur BUILD-Zeit aufgelöst und in data/companies/ geschrieben — 435 der 533 Unternehmen haben eines. Beim Lesen wird Wikidata daher nichts gefragt: es erfährt nie, welches Unternehmen Sie ansehen. Das Bild selbst liefert Wikimedia Commons (Special:FilePath, weitergeleitet auf upload.wikimedia.org). Für ein Unternehmen, zu dem Commons kein Logo hat, ist der Favicon-Dienst von Google der Ersatz, und dabei wird ausschließlich der DOMAINNAME des Unternehmens an Google gesendet. Fehlt beides, wird ein Monogramm aus den Anfangsbuchstaben gezeichnet — dabei entsteht überhaupt keine externe Anfrage. Die Marken gehören den Unternehmen, die sie kennzeichnen, und werden hier nur zu deren Kennzeichnung verwendet; die Lizenz steht bei jeder DATEI auf Commons einzeln (die meisten Wortmarken erreichen die Schöpfungshöhe nicht und sind gemeinfrei, einige stehen unter einer CC-Lizenz). ⚠ Dies ersetzt die Clearbit Logo API, die am 2025-12-08 abgeschaltet wurde: logo.clearbit.com wird gar nicht mehr aufgelöst, und ein einziges Öffnen des Reiters erzeugte 189 fehlgeschlagene Namensauflösungen.',
...
'Smithsonian GVP': 'Mit der App ausgeliefert (data/volcanoes_gvp.json und data/volcano-detail.json.gz, von scripts/build-volcanoes.mjs aus dem WFS des GVP erzeugt): der gesamte Holozän-Katalog mit seinem Verknüpfungsschlüssel und dahinter jeder Ausbruch, den das GVP für die Vulkane dieses Katalogs verzeichnet, mit VEI und Datumsangaben, dazu Vulkantyp, Landform, tektonische Lage und vorherrschendes Gestein, die geologische Zusammenfassung, das Foto und die Bevölkerung im Umkreis von 5, 10, 30 und 100 km. Alles, was die Vulkan-Infokarte über die Vergangenheit sagt, wird offline aus dieser Datei gelesen. Der Katalog ist die Holozän-Liste plus die Vulkane, für die ein Observatorium eine aktuelle Warnstufe veröffentlicht: Yellowstone, Long Valley, das Vulkanfeld Coso und die Isanotski Peaks sind älter als das Holozän und stammen aus dem Pleistozän-Katalog des GVP, damit auch ein Vulkan gezeichnet werden kann, über den der USGS jeden Tag berichtet.',
    ...
    'OpenHistoricalMap (CC0 1.0)': 'Taggenaue Grenzen für 1850–1885 — die Jahre unterhalb der Untergrenze 1886 von CShapes —, mit der App ausgeliefert (data/hist-borders.js, von scripts/build-hist-borders.mjs aus den Grenzrelationen mit admin_level=2 von OpenHistoricalMap erzeugt). 494 Datensätze, die ihr Anfangs- und Enddatum taggenau tragen, 216 verschiedene Übergangsdaten innerhalb dieses Zeitfensters und 164–216 Gemeinwesen, die an jedem beliebigen 15. Juni darin bestehen — gegenüber dem einen Stand von 1880, den sich diese sechsunddreißig Jahre bisher teilten. Die Namen der Gemeinwesen reisen mit den Polygonen in den neun Sprachen der App mit, übernommen aus den name:xx-Tags von OHM selbst. Die Verwaltungseinheiten der ersten Ebene — Bundesländer, Provinzen, Präfekturen, Oblaste — des Jahres, auf das die Hauptuhr gestellt ist. Mit der App ausgeliefert als data/hist-admin1.js, gebaut von scripts/build-hist-admin1.mjs aus den Grenzrelationen der OHM auf admin_level 3–4: die 3.053 Einheiten mit start_date und/oder end_date, mit Douglas–Peucker auf 0,02° (rund 2,2 km) vereinfacht, ab 1850. Lizenz CC0 1.0, eine Namensnennung ist also nicht geschuldet; der Eintrag steht hier, weil die Karte diese Daten zeichnet. ⚠ DIE ABDECKUNG IST UNVOLLSTÄNDIG, UND DIE KARTE SAGT DAS, STATT SIE AUFZUFÜLLEN: 1900 sind 642 Einheiten in Kraft gegenüber rund 4.600 heutigen Einheiten der ersten Ebene. Ein Land, das in einem vergangenen Jahr ohne Untergliederungslinie gezeichnet wird, ist eines, über das der Datenbestand noch schweigt — nicht eines ohne Untergliederung.',
    ...
    "Religion and language composition by country — CIA World Factbook (US Government work, public domain)": "Mitgeliefert: die Felder „Religions“ und „Languages“ des Factbook, in Anteile je Gruppe und Land zerlegt (202 bzw. 204 Länder). Wo das Factbook die Konfessionen nicht trennt, trennt die Karte sie auch nicht.",
    "Language identity, genealogical classification and endangerment status — Glottolog (CC BY 4.0)": "Mitgeliefert: Glottologs Languoid-Katalog — jede Sprache und jede Sprachfamilie, mit Glottocode, Elternknoten, ISO-639-3-Code und Gefährdungsstatus. Erst dadurch hat die Sprachebene eine Identität, über die sie recht haben kann. Unter den abgelösten ISO-639-1-Kürzeln teilten sich das Kreol von Mauritius und das von Haiti einen Code, Kirundi wurde als Kinyarwanda geführt, und sechs sinitische Sprachen hatten ein gemeinsames Kürzel; und weil die alte Tabelle Unbekanntes stillschweigend verwarf, erschien Burkina Faso als Fula 7,8 %, während Mossi mit 52,9 % fehlte. Jeder Name, den das Factbook druckt, wird jetzt über eine benannte Regel oder eine schriftliche Entscheidung in data/language-aliases.json auf einen Glottocode aufgelöst — ein Name, der weder das eine noch das andere hat, lässt den Build scheitern.",
