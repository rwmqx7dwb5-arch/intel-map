...
,
  ...
  /* (#R547) photo.locate — vision-model skyline detection · js/photo-geo.js */
  "Vision model": "AI 视觉模型",
  "Image processing": "影像处理",
  "This sends your photograph.": "此方式会传送您的照片。",
  "A reduced copy of the picture goes to the AI provider IntMap calls, to be traced. It is not stored. The image-processing detector sends nothing at all.": "缩小后的照片副本会传送给 IntMap 所使用的 AI 服务供应商，用来描出棱线，且不会被保存。影像处理方式的侦测则完全不会传送任何东西。",
  "Allow and detect": "允许并侦测",
  "Sending the photograph is allowed on this browser.": "本浏览器已允许传送照片。",
  "Withdraw": "撤回",
  "Asking the model where the sky stops…": "正在请模型判断天空到哪里为止…",
  "Traced by": "侦测方式",
  "model confidence": "模型信心度",
  "over evaluated columns": "以实际评估的栏计",
  "The photograph has not been sent — allow it above first.": "照片尚未传送——请先在上方允许。",
  "No connection. The image-processing detector still works offline.": "没有连接。影像处理方式的侦测在离线时仍可使用。",
  "An account is needed to ask the model. The image-processing detector needs none.": "询问模型需要账号；影像处理方式的侦测则不需要。",
  "The model found no sky-and-land boundary in this photograph.": "模型在这张照片中找不到天空与地面的分界。",
  "The reply traced too few points to be a ridge.": "回复描出的点太少，构不成棱线。",
  "The traced ridge covers too little of the frame to search with.": "描出的棱线涵盖的画面范围太小，无法用来搜索。",
  "The reply could not be read.": "无法读取回复。",
  "A reduced copy of your photograph was sent to the AI provider IntMap calls, to trace the ridge. It was not stored. Everything after that — the camera model, the sweep and the match — ran in this browser, and the elevation tiles were fetched by coordinate.": "为了描出棱线，缩小后的照片副本已传送给 IntMap 所使用的 AI 服务供应商，且未被保存。之后的一切——相机模型、扫描与比对——都在这个浏览器中完成，高程瓦片则是依坐标下载的。",
