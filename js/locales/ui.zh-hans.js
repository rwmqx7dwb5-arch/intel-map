...
,
  ...
  "{n} row(s) had no usable value and are not drawn": "{n} 列没有可用的数值，因此未绘出",   /* atlas-chart.js (#R540) */
  "a {kind} needs at least {min} real points; {n} arrived": "{kind} 至少需要 {min} 个实际数据点，但只收到 {n} 个",   /* atlas-chart.js (#R540) */
  "a bar chart needs at least {min} labelled values; {n} arrived": "条形图至少需要 {min} 个具名数值，但只收到 {n} 个",   /* atlas-chart.js (#R540) */
  "a timeline needs at least {min} dated events; {n} arrived": "年表至少需要 {min} 个有日期的事件，但只收到 {n} 个",   /* atlas-chart.js (#R540) */
  "chart kind must be one of {kinds}": "图表种类必须是 {kinds} 其中之一",   /* atlas-chart.js (#R540) */
  "every chart must say where its numbers came from (source)": "每张图表都必须说明数字的来源（source）",   /* atlas-chart.js (#R540) */
  "{kind} chart, {x0} to {x1}, values {y0} to {y1}": "{kind} 图表，{x0} 至 {x1}，数值 {y0} 至 {y1}",   /* atlas-chart.js (#R540) */
  "bar chart, {n} values from {y0} to {y1}": "条形图，{n} 个数值，从 {y0} 至 {y1}",   /* atlas-chart.js (#R540) */
  "timeline, {n} events from {y0} to {y1}": "年表，{y0} 年至 {y1} 年共 {n} 个事件",   /* atlas-chart.js (#R540) */
  "The chart renderer could not be loaded.": "无法加载图表绘制模块。",   /* atlas-console.js (#R540) */
  "Map as it was": "当时的地图",   /* atlas-msg-tools.js (#R540) */
  "Put the map back the way it was when this answer was written": "将地图还原成撰写这则回答时的状态",   /* atlas-msg-tools.js (#R540) */
  "Restored": "已还原",   /* atlas-msg-tools.js (#R540) */
  "Restored ({n} later layer(s) left on)": "已还原（之后开启的 {n} 个图层维持不变）",   /* atlas-msg-tools.js (#R540) */
  "Could not restore": "无法还原",   /* atlas-msg-tools.js (#R540) */
  "Unavailable": "无法使用",   /* atlas-msg-tools.js (#R540) */
  }
});
