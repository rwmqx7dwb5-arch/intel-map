...
,
  ...
  "Vision model": "AI 視覺模型",
  "Image processing": "影像處理",
  "This sends your photograph.": "此方式會傳送您的照片。",
  "A reduced copy of the picture goes to the AI provider IntMap calls, to be traced. It is not stored. The image-processing detector sends nothing at all.": "縮小後的照片副本會傳送給 IntMap 所使用的 AI 服務供應商，用來描出稜線，且不會被保存。影像處理方式的偵測則完全不會傳送任何東西。",
  "Allow and detect": "允許並偵測",
  "Sending the photograph is allowed on this browser.": "本瀏覽器已允許傳送照片。",
  "Withdraw": "撤回",
  "Asking the model where the sky stops…": "正在請模型判斷天空到哪裡為止…",
  "Traced by": "偵測方式",
  "model confidence": "模型信心度",
  "over evaluated columns": "以實際評估的欄計",
  "The photograph has not been sent — allow it above first.": "照片尚未傳送——請先在上方允許。",
  "No connection. The image-processing detector still works offline.": "沒有連線。影像處理方式的偵測在離線時仍可使用。",
  "An account is needed to ask the model. The image-processing detector needs none.": "詢問模型需要帳號；影像處理方式的偵測則不需要。",
  "The model found no sky-and-land boundary in this photograph.": "模型在這張照片中找不到天空與地面的分界。",
  "The reply traced too few points to be a ridge.": "回覆描出的點太少，構不成稜線。",
  "The traced ridge covers too little of the frame to search with.": "描出的稜線涵蓋的畫面範圍太小，無法用來搜尋。",
  "The reply could not be read.": "無法讀取回覆。",
  "A reduced copy of your photograph was sent to the AI provider IntMap calls, to trace the ridge. It was not stored. Everything after that — the camera model, the sweep and the match — ran in this browser, and the elevation tiles were fetched by coordinate.": "為了描出稜線，縮小後的照片副本已傳送給 IntMap 所使用的 AI 服務供應商，且未被保存。之後的一切——相機模型、掃描與比對——都在這個瀏覽器中完成，高程圖磚則是依座標下載的。",
