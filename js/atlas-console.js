  ...
  return (function(){
    ...
    const LAYER_ALIASES={
      ...
      /* ⚠ (#R409) THE TWO DAY-BY-DAY WAR LAYERS HAD NO ALIAS AT ALL, in any language: 「第二次世界大戦」 was routed to the approximate
         whole-world `historicalMap` while the record sat one row away, reachable only by its full label. ⚠ ONE LINE — tests/r318 ⑨b. */
      'ww1':'dl-ww1','wwi':'dl-ww1','world war 1':'dl-ww1','world war i':'dl-ww1','world war one':'dl-ww1','first world war':'dl-ww1','great war':'dl-ww1','第一次世界大戦':'dl-ww1','第一次大戦':'dl-ww1','一次大戦':'dl-ww1','erster weltkrieg':'dl-ww1','первая мировая война':'dl-ww1','primera guerra mundial':'dl-ww1','première guerre mondiale':'dl-ww1','제1차 세계 대전':'dl-ww1','第一次世界大戰':'dl-ww1', 'ww2':'dl-ww2','wwii':'dl-ww2','world war 2':'dl-ww2','world war ii':'dl-ww2','world war two':'dl-ww2','second world war':'dl-ww2','第二次世界大戦':'dl-ww2','第二次大戦':'dl-ww2','二次大戦':'dl-ww2','太平洋戦争':'dl-ww2','zweiter weltkrieg':'dl-ww2','вторая мировая война':'dl-ww2','segunda guerra mundial':'dl-ww2','seconde guerre mondiale':'dl-ww2','제2차 세계 대전':'dl-ww2','第二次世界大戰':'dl-ww2',
