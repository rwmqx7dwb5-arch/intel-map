...
export function makeAtlasToolSurface(deps) {
  return (function () {
    ...
    var CORE = [
      ...
      /* ══ ⚠⚠ (#R540) THE OTHER OUTPUT, IN CORE FOR THE SAME REASON. `compose_map` is above because a
    ...
    function mechanical(res, built) {
      ...
      /* ⚠ (#R540) …AND THE SAME FACT FOR EVERY OTHER OUTPUT AN ANSWER CAN BE. The line below used to
